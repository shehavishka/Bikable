...
<?php require APPROOT . '/views/inc/header-mechanic.php'; ?>
    ...
    <div id="container">
        ...
        <div id="upper_section">
            <div class="title" id="title">Repair Logs</div>
            <div class="add_btn" id="add_btn">
                <a href="<?php echo URLROOT;?>/mechanics/createRepairLog"><img src="<?php echo URLROOT;?>/public/images/general/add.png" alt="add"></a>
            </div>
        </div> 

        <div class="middle_section">
            <?php foreach($data['repairLogsDetailObject'] as $oneObject) : ?>
                <div class="reportRecord">
                    ...
                    <div class="edit_btn">
                        <a href="<?php echo URLROOT;?>/mechanics/editReport?reportID=<?php echo $oneObject->reportID;?>"><img src="<?php echo URLROOT;?>/public/images/admins/viewIcon1.png" alt="edit"></a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
