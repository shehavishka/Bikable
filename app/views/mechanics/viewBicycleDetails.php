        ...
        <form action="<?php echo URLROOT; ?>/mechanics/editBicycleDetails" method="POST" id="userInterface">
            ...
            <div class="data__area--detail">
                ...
                <div class="data__area__detail--role">
                    <div class="data--name--label">Bicycle ID: <?php echo $data['bicycleDetailObject']->bicycleID; ?></div>
                ...
                <div class="data__area__detail--name">
                    ...
                    <div class="data__area__div data--bikeOwnerID">
                        <div class="data--name--label">Bicycle Owner ID</div>
                    ...
                    <div class="data__area__div data--frameSize">
                        <div class="data--name--label">Frame Size</div>
                ...
                <div class="data__area__detail--status">
                    ...
                    <div class="data__status">
                        <div class="data__status--active">
                            <input type="radio" id="active" name="status" value="0" <?php if ($data['bicycleDetailObject']->status == 0) {
                                                                                        echo 'checked';
                                                                                    } ?>>
                            <label for="active">Active</label>
                        </div>
                        <div class="data__status--inactive">
                            <input type="radio" id="inactive" name="status" value="1" <?php if ($data['bicycleDetailObject']->status == 1) {
                                                                                            echo 'checked';
                                                                                        } ?>>
                ...
                <div class="data__area__detail--number">
                    <div class="data__area__detail--dateAcquired">
                        <div class="data--name--label">Date Acquired</div>
                    ...
                    <div class="data__area__detail--datePutInUse">
                        <div class="data--name--label">Date Put Into Use</div>
                ...
                <div class="data__area__detail--role">
                    <div class="data--name--label">Current Docking Area</div>
