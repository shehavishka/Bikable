...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/mechanics/addBike.css">
...
<body>
    ...
    <section class="data_area">
        ...
        <!-- REAL DATA AREA -->
        <form action="<?php echo URLROOT;?>/mechanics/addBicycle" method="POST" id="userInterface">
