...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/mechanics/repairLog.css">
        ...
        <div class="admin__data__area--top">
            ...
            <div class="admin__data_area__top--twobuttons">
                <div class="add_user_button">
                    <input type="button" class="btn btn_add" value="View Active" onclick="location.href='<?php echo URLROOT;?>/mechanics/repairLogsControl'">
                </div>
                
                <form action="<?php echo URLROOT;?>/mechanics/unarchiveRepairLogs" method="POST" id="userInterface">
            ...
            <table>
                <tr>
                    ...
                    <tr>
                        ...
                        <a href="<?php echo URLROOT;?>/mechanics/viewRepairLog?logID=<?php echo $oneObject->logID;?>"><img src="<?php echo URLROOT;?>/public/images/mechanics/editIcon1.png" alt="edit"></a>
                    </tr>
                <?php endforeach; ?>
