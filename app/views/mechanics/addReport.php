...
<body>
    <!-- finalized side bar -->
    <?php require APPROOT . 'sidebar-mechanic.php'; ?>
    ...
    <section class="admin_data_area">
        ...
        <!-- dashboard section -->
        <?php require APPROOT . 'header.php'; ?>
            ...
            <table>
                <tr>
                    ...
                    <tr>
                        ...
                        <a href="<?php echo URLROOT;?>/mechanics/editReportDetails?reportID=<?php echo $oneObject->reportID;?>"><img src="<?php echo URLROOT;?>/public/images/mechanics/editIcon1.png" alt="edit"></a>
                    </tr>
                <?php } endforeach; 
