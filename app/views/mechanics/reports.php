            ...
            <table>
                <tr>
                    ...
                    <tr>
                        ...
                        <a href="<?php echo URLROOT;?>/mechanics/viewReport?reportID=<?php echo $oneObject->reportID;?>"><img src="<?php echo URLROOT;?>/public/images/mechanics/viewIcon1.png" alt="edit"></a>
                    </tr>
                <?php endforeach; 
