...
<?php require APPROOT . '/views/inc/header-mechanic.php'; ?>
    ...
    <div class="floating-panel" id="floating-panel">
        ...
        <div id="scan_button">
            <a href="<?php echo URLROOT;?>/mechanics/scanQR"><img src="<?php echo URLROOT;?>/public/images/general/scanIcon1.png" alt="scan"></a>
        </div>
            ...
            function initMap(){
                ...
                areas.forEach(({ position, title, label, label_big, id }, i) => {
                    const marker = new google.maps.Marker({
                        ...
                        map,
                        title,
                        icon: {url:"<?php echo URLROOT; ?>/public/images/mechanics/map_icon.png", labelOrigin: new google.maps.Point(43, 18)},
                        label,
                    ...
                    google.maps.event.addListener(marker, 'click', (function(marker, i) {
                        return function() {;
                            ...
                            markers[j].setIcon({url:"<?php echo URLROOT; ?>/public/images/mechanics/map_icon.png", labelOrigin: new google.maps.Point(43, 18)});
                            markers[j].setLabel(areas[j].label);
                            }
                            marker.setIcon({url:"<?php echo URLROOT; ?>/public/images/mechanics/map_icon2.png", labelOrigin: new google.maps.Point(110, 43)});
                ...
                function panelExpand(id, position) {
                    ...
                    getCurrentPosition().then(function(pos) {
                        ...
                        xhttp.open("GET", "<?php echo URLROOT; ?>/mechanics/getMapDADetails?q="+id+"&lat="+pos[0]+"&long="+pos[1], true);
                        xhttp.send();
