...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/admins/viewRepairLog.css">
...
<body>
    ...
    <section class="data_area">
        ...
        <!-- REAL DATA AREA -->
        <form action="<?php echo URLROOT;?>/admins/deleteRepairLog" method="POST" id="userInterface">
            ...
            <div class="data__area--top">
                ...
                <div class="data_area__top--twobuttons">
                    <div class="add_user_button">
                        <input type="button" class="btn btn_add" value="Back" onclick="location.href='<?php echo URLROOT;?>/admins/repairLogControl'">
                    </div>
