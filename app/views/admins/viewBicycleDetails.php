...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/admins/viewBicycle.css">
...
<body>
    ...
    <section class="data_area">
        ...
        <!-- REAL DATA AREA -->
        <form action="<?php echo URLROOT;?>/admins/editBicycleDetails" method="POST" id="userInterface">
            <!-- admin real data top -->
