...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/admins/changePassword.css">
        ...
        <div class="admin__data__area--top">
            ...
            <div class="admin__data_area__top--twobuttons">
                <div class="delete_user_button">
                    <input type="button" class="btn btn_delete" value="Cancel" onclick="location.href='<?php echo URLROOT;?>/admins/profilePage'">
                </div>
            </div>
