...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/admin/addUser.css">
        ...
        <div class="data__area--top">
            ...
            <div class="data_area__top--twobuttons">
                <div class="add_user_button">
                    <input type="button" class="btn btn_add" value="Cancel" onclick="location.href='<?php echo URLROOT;?>/admins/adminLandPage'">
                </div>
                <div class="delete_user_button">
                    <input type="button" class="btn btn_delete" value="Submit" onclick="location.href='<?php echo URLROOT;?>/admins/addUserToTheSystemFormSubmitButton'">
                </div>
            </div>
