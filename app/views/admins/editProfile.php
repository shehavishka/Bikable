    ...
    <section class="admin_data_area">
        ...
        <section class="data__area">
            ...
            <div class="right--side">
                <form action="<?php echo URLROOT;?>/admins/profileEdit" method="post">
                    <div class="detail__view--card">
                        ...
                        <div class="user__detail">
                            ...
                            <div class="user_detail_x">
                                ...
                                <div class="signupView__Detail--data">
                                    <input type="text" class="signupDetailbox" name="pNumber" value="<?php echo $_SESSION['user_pNumber']; ?>">
                                    <br><span style="color: red;"><?php echo $data['pNumber_err'];?></span>
                                </div>
                            </div>
