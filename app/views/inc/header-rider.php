...
<div id="mySidenav" class="sidenav">
    ...
    <a href="<?php echo URLROOT;?>/riders/viewWallet"><div class="item i4"><img style="padding:0;margin-right:25px;" src="<?php echo URLROOT;?>/public/images/general/cardIcon.png" alt="menu">Wallet</div></a>
