...
<div id="mySidenav" class="sidenav">
    ...
    <a href="<?php echo URLROOT;?>/mechanics/viewRepairLogs"><div class="item i2"><img style="padding:0;margin-right:20px;" src="<?php echo URLROOT;?>/public/images/mechanics/dashboardIcons/setting.png" alt="menu"> Repair Logs</div></a>
    <a href="<?php echo URLROOT;?>/mechanics/profilePage"><div class="item i3"><img style="padding:0;margin-right:22px;" src="<?php echo URLROOT;?>/public/images/general/userIcon.png" alt="menu">View Profile</div></a>
    ...
    <a href="<?php echo URLROOT;?>/mechanics/viewReports"><div class="item i5"><img style="padding:0;margin-right:22px;" src="<?php echo URLROOT;?>/public/images/general/reportIcon.png" alt="menu">Make a Report</div></a>
