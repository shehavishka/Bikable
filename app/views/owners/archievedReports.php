...
<body>
    ...
    <section class="admin_data_area">
        ...
        <div class="admin__data__area--top">
            <div class="admin__data__area__top--title">Archieved Reports</div>
            <div class="admin__data_area__top--twobuttons">
                <div class="add_user_button">
                    <input type="button" class="btn btn_add" value="View Active" onclick="location.href='<?php echo URLROOT;?>/owners/reportsControl'">
                </div>
    
    <form action="<?php echo URLROOT;?>/owners/unarchiveReports" method="POST" id="userInterface">
                <div class="delete_user_button">
                    <input type="submit" class="btn btn_delete" value="Unrchive Selected">
                </div>
            </div>
