...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/owners/viewBicycle.css">
...
<body>
    ...
    <section class="data_area">
        ...
        <!-- REAL DATA AREA -->
        <form action="<?php echo URLROOT;?>/owners/editBicycleDetails" method="POST" id="userInterface">
            <!-- admin real data top -->
            <div class="data__area--top">
                <div class="data__area__top--title">Edit Bicycle Details</div>
                <div class="data_area__top--twobuttons">
                    <div class="add_user_button">
                        <input type="button" class="btn btn_add" value="Cancel" onclick="location.href='<?php echo URLROOT;?>/owners/bicyclesControl'">
                    </div>
            ...
            <div class="data__area--detail">
                ...
                <div class="data__area__detail--role">
                    ...
                    <br><span class="error_text" style="color: red;"><?php echo $data['currentDA_err'];?></span>
                </div>
