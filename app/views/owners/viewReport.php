...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/owners/viewReport.css">
    <title>Report</title>
</head>
<body>
    <!-- finalized side bar -->
    ...
    <section class="data_area">
        ...
        <!-- REAL DATA AREA -->
        <form action="<?php echo URLROOT;?>/owners/editReportDetails" method="POST" id="userInterface">
            ...
            <div class="data__area--top">
                ...
                <div class="data_area__top--twobuttons">
                    <div class="add_user_button">
                        <input type="button" class="btn btn_add" value="Back" onclick="location.href='<?php echo URLROOT;?>/owners/reportsControl'">
                    </div>
